    ...
    const questionnaires = [
        {
            ...
            preguntas: ["1. ¿Cómo crees que la inteligencia artificial cambiará el mercado laboral en los próximos 10 años?",
    ...
    return (
        <Container>
            ...
            {questionnaires.map((questionnaire) =>
                <Forms title={questionnaire.title} questions={questionnaire.preguntas} />
            )}
